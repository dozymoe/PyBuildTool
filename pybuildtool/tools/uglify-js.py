...
Options:
    ...
    * expr              : bool, None
                          ...
                          (for parsing JSON)
    * prefix            : str, None
                          Skip prefix for original filenames that appear in
                          source maps. For example --prefix 3 will drop 3
                          directories from file names and ensure they are
                          relative paths. You can also specify --prefix
                          relative, which will make UglifyJS figure out itself
                          the relative paths between original sources, the
                          source map and the output file
    * beautify          : str, None
    ...
    * compress          : str, None
                          Enable compressor/pass compressor options.
                          Pass options like
    ...
    * preamble          : str, None
                          Preamble to prepend to the output. You can use this
                          to insert a comment, for example for licensing
    ...
    * spidermonkey      : bool, None
                          Assume input files are SpiderMonkey AST format (as
                          JSON)
    * self              : bool, None
    ...
    * wrap              : str, None
                          ...
                          need to pass an argument to this option to specify
                          the name that your model will take when included in,
                          say, a browser
    * export-all        : bool, None
                          Only used when --wrap, this tells UglifyJS to add
    ...
    * verbose           : bool, None
                          Verbose
    * noerr             : bool, None
                          Don't throw an error for unknown options in
                          --compress, --beautify, --mangle
